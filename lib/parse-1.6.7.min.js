  ...
  ({
    1:[function(e,t,r){
      ...
      o["default"].setAnalyticsController({track:function(e,t){
        ar r=o["default"].getRESTController();
    ...
    2:[function(e,t,r){
      ...
      function n(e,t,r){
        ...
        return o["default"].getCloudController().run(e,t,{useMasterKey:r.useMasterKey})._thenRunCallbacks(r)
      }
      var a=e("babel-runtime/helpers/interop-require-default")["default"];
      Object.defineProperty(r,"__esModule",{value:!0}), r.run=n;
      var s=e("./CoreManager"),o=a(s),i=e("./decode"),u=a(i),l=e("./encode"),
            c=a(l),f=e("./ParseError"),d=a(f),h=e("./ParsePromise"),p=a(h);
      o["default"].setCloudController({
        run:function(e,t,r){
          var n=o["default"].getRESTController(),a=(0,c["default"])(t,!0),
              s=n.request("POST","functions/"+e,a,{useMasterKey:!!r.useMasterKey});
          return s.then(function(e){
            var t=(0,u["default"])(e);
            return t&&t.hasOwnProperty("result")?p["default"].as(t.result):p["default"].error(
              new d["default"](d["default"].INVALID_JSON,"The server returned an invalid response.")
            )
          })._thenRunCallbacks(r)
        }
      })
    ...
    3:[function(e,t,r){
      (function(e){
        "use strict";
        var r={
          IS_NODE:"undefined"!=typeof e&&!!e.versions&&!!e.versions.node,REQUEST_ATTEMPT_LIMIT:5,
          SERVER_URL:"http://localhost:1337/apps",
          VERSION:"1.6.7",
          APPLICATION_ID:null,
          JAVASCRIPT_KEY:null,
          MASTER_KEY:null,
        ...
        t.exports={
          ...
          getAnalyticsController:function(){return r.AnalyticsController},
          ...
          getFileController:function(){return r.FileController},
          ...
          getInstallationController:function(){return r.InstallationController},
          setPushController:function(e){
            if("function"!=typeof e.send)throw new Error("PushController must implement send()");
            r.PushController=e
          },
          getPushController:function(){return r.PushController},
          ...
          getObjectController:function(){return r.ObjectController},
          setQueryController:function(e){
            if("function"!=typeof e.find)throw new Error("QueryController must implement find()");
            r.QueryController=e
          },
          getQueryController:function(){return r.QueryController},
          ...
          getRESTController:function(){return r.RESTController},
          ...
          getSessionController:function(){return r.SessionController},
          ...
          getStorageController:function(){return r.StorageController},
          ...
          getUserController:function(){return r.UserController}}}).call(this,e("_process"))
        },{_process:49}
      ],
    4:[
      function(e,t,r){
        ...
        var a,s,o=e("./parseDate"),i=n(o),u=e("./ParseUser"),l=n(u),c=!1;r["default"]={
          init:function(e){
            ...
            s.status=!1,FB.init(s),l["default"]._registerAuthenticationProvider({
              authenticate:function(e){
                var t=this;"undefined"==typeof FB&&e.error(this,"Facebook SDK not found."),FB.login(function(r){
